...
export declare type GetFindResult<P extends OperationPayload, A> =
  Equals<A, any> extends 1 ? DefaultSelection<P> : A extends
    | {
      ...
      & {
        [
          ...
          ? P extends SelectablePayloadFields<K, (infer O)[]>
            ? O extends OperationPayload ? GetFindResult<O, (S & I)[K]>[]
            : never
...
declare class RequestHandler {
  ...
  handleRequestError(
    { error, clientMethod, callsite, transaction, args, modelName }:
      HandleErrorParams,
  ): never;
...
declare function resolveDatasourceUrl(
  { inlineDatasources, overrideDatasources, env, clientVersion }: {
    inlineDatasources: GetPrismaClientConfig["inlineDatasources"];
    overrideDatasources: Datasources;
    env: Record<string, string | undefined>;
    clientVersion: string;
