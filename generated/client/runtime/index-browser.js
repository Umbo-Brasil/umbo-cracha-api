...
h.inverseCosine = h.acos = function () {
  var e,
    ...
    s = i.rounding;
  return t !== -1
    ? t === 0 ? n.isNeg() ? L(i, r, s) : new i(0) : new i(NaN)
    : n.isZero()
    ? L(i, r + 4, s).times(.5)
    : (i.precision = r + 6,
      i.rounding = 1,
...
h.inverseSine = h.asin = function () {
  ...
  return r.isZero()
    ...
    : (n = r.abs().cmp(1),
      ...
      t = s.rounding,
      n !== -1
        ? n === 0 ? (e = L(s, i + 4, t).times(.5), e.s = r.s, e) : new s(NaN)
        : (s.precision = i + 6,
          s.rounding = 1,
...
h.toFraction = function (e) {
  ...
  return r = S(e.minus(i), t, 0, 1, 1),
    l = l.plus(r.times(f)),
    i = i.plus(r.times(t)),
    l.s = f.s = g.s,
    d = S(f, t, s, 1).minus(g).abs().cmp(S(l, i, s, 1).minus(g).abs()) < 1
      ? [f, t]
      : [l, i],
    N.precision = c,
    w = !0,
...
function Q(e, n, i, t) {
  ...
  return --n < 0 ? (n += m, r = 0) : (r = Math.ceil((n + 1) / m), n %= m),
    s = M(10, m - n),
    u = e[r] % s | 0,
    t == null
      ? n < 3
    ...
    if (
      ...
      if (I = I / g + 2 | 0, a = 0, T == 1) {
        ...
        for (
          d = l / (k[0] + 1) | 0,
            d > 1 &&
            (k = e(k, d, l), b = e(b, d, l), T = k.length, G = b.length),
            z = T,
            E = b.slice(0, T),
            P = E.length;
          P < T;
...
function p(e, n, i, t) {
  ...
  e: if (n != null) {
    ...
    if (
      t = t || n < 0 || a[d + 1] !== void 0 ||
        (o < 0 ? c : c % M(10, r - o - 1)),
        f = i < 4 ? (l || t) && (i == 0 || i == (e.s < 0 ? 3 : 2)) : l > 5 ||
          l == 5 &&
            (i == 4 || t ||
              i == 6 &&
                (s > 0 ? o > 0 ? c / M(10, r - o) : 0 : a[d - 1]) % 10 & 1 ||
              i == (e.s < 0 ? 8 : 7)),
        n < 1 || !a[0]
    ) {
      return a.length = 0,
    ...
    if (
      s == 0
        ...
        : (a.length = d + 1,
          u = M(10, m - s),
          a[d] = o > 0 ? (c / M(10, r - o) % M(10, o) | 0) * u : 0), f
    ) {
      for (;;) {
        if (d == 0) {
...
function Ue(e, n, i, t) {
  ...
  for (w = !1;;) {
    if (
      i % 2 && (s = s.times(n), Re(s.d, o) && (r = !0)), i = A(i / 2), i === 0
    ) {
...
function Ee(e, n) {
  ...
  for (n == null ? (w = !1, l = v) : l = n, u = new d(.03125); e.e > -2;) {
    e = e.times(u), a += 5;
  }
  for (
...
function ke(e, n, i, t) {
  ...
  if (
    v
      ...
      : (i = g.precision, t = g.rounding), !e.isFinite()
  ) c = $e(e);
  else {
    for (
      c = F(e),
...
function mn(e, n) {
  ...
  return !e.s || !n.s
    ? i = new this(NaN)
    : !e.d && !n.d
    ? (i = L(this, s, 1).times(n.s > 0 ? .25 : .75), i.s = e.s)
    : !n.d || e.isZero()
    ? (i = n.s < 0 ? L(this, t, r) : new this(0), i.s = e.s)
    : !e.d || n.isZero()
    ? (i = L(this, s, 1).times(.5), i.s = e.s)
    : n.s < 0
    ? (this.precision = s,
      this.rounding = 1,
